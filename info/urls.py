...
from movies.api import views as movies_views
...
router.register(r'person', movies_views.PersonViewSet)
router.register(r'role', movies_views.RoleViewSet)
router.register(r'genre', movies_views.GenreViewSet)
router.register(r'movie', movies_views.MovieViewSet)
router.register(r'series', movies_views.SeriesViewSet)
